        ...
        <section id='home' className='w-full flex flex-col gap-6 h-fit px-5 pt-25 pb-35 relative'>
            ...
            <article className='flex flex-col gap-6'>
                ...
                <div className='flex w-full items-center gap-2'>
                    <button className='bg-primary-500 py-3 rounded-md border shadow-sm shadow-black/30 border-white px-3 font-medium h-fit text-xs w-fit text-white'>Solicitar Orçamento</button>
