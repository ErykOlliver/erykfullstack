...
export default function NetworkButton({ icon, label }: props) {
    return (
        <div className='relative group'>
            <div className='w-fit h-fit group-hover:shadow-md shadow-primary-700 group-hover:cursor-pointer p-1.5 transition-all duration-150 flex items-center justify-center rounded-md group-hover:text-white group-hover:bg-primary-500 text-black-800'>
                {icon}
            </div>
