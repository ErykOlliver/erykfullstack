...
export default function ContactRoute() {
    return (
        <section className='w-full flex flex-col items-start justify-center h-fit '>
            <article className='w-full h-fit pb-25 px-10 pt-45 bg-linear-to-r from-primary-700 via-orange-500 to-orange-400 text-white flex flex-col items-center justify-center gap-2.5'>
                <Heading level={4} className='md:text-6xl uppercase font-black text-center'>Vamos conversar sobre seu projeto!</Heading>
