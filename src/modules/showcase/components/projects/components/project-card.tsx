...
export default function ProjectCard() {
    return (
        <article className='aspect-video w-full shadow-black/25 flex items-end rounded-lg border-white border-2 shadow-md relative'>
            ...
            <div className='absolute z-10 px-2 py-0.5 shadow-xs shadow-black/50 left-0 bottom-1/2 -translate-y-1/2 bg-primary-500'><Paragraph className='text-white md:text-sm'>Landing Page</Paragraph></div>
