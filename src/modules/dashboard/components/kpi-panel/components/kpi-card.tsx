...
export default function KpiCard({ amount, icon, title }: typeKpiCard) {
    return (
        <article className='flex flex-col select-none items-start justify-between aspect-video w-full h-auto border border-black-300 p-2 md:p-4 xl:p-5 rounded-lg'>
